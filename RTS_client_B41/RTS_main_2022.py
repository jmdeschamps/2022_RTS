...
class Controleur():
    ...
    # le boucler_sur_lobby a reçu code ('courant') et appel cette fonction pour tous
    ...
    def boucler_sur_jeu(self):
        ...
        self.vue.root.after(self.maindelai,self.boucler_sur_jeu) # appel ulterieur de la meme fonction jusqu'a l'arret de la partie
